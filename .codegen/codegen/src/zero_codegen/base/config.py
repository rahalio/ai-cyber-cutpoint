...
class Config(BaseModel):
    ...
    # npm scope for generated imports, e.g. "@cutpoint" → "@cutpoint/core", "@cutpoint/services"
    package_scope: str = Field("@cutpoint", description="npm package scope used in generated TypeScript imports")
