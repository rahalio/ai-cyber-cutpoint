...
{method_body}
        ...
        port_import = f"import type {{\n  {ports_list},\n}} from \"@cutpoint/services/{context.domain_name}\";\n"
...
"""
    ...
    def _generate_dto_imports(
        ...
        for resource in sorted(resource_to_types.keys()):
            ...
            import_lines.append(f"import type {{ {types_str} }} from \"@cutpoint/services/{context.domain_name}/dto/{kebab_case(resource)}-dto\";")
