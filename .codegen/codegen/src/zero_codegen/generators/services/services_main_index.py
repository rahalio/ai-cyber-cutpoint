 ...
 *   import {{ activity, ai, conversation }} from "@cutpoint/services";
 *   const {{ usecases, dto, ports }} = activity;
 *
 *   // Direct imports from domain
 *   import {{ ExecuteCreateEventUseCase }} from "@cutpoint/services/activity";
 *   
 *   // Shared services
 *   import {{ executionContextService }} from "@cutpoint/services";
 */
