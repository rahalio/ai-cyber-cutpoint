...
class WebappContractsGenerator(WebappServicesFileGenerator):
    """
    Generates contracts file (Zod schemas re-exports from @cutpoint/core)
 ...
 *
 * @see @cutpoint/core/{domain_name} for the source schemas
 */

import {{ {domain_name}Schemas as core{domain_pascal}Schemas }} from "@cutpoint/core/{domain_name}";
...
class WebappApiTypesGenerator(WebappServicesFileGenerator):
    """
    Generates API types file (TypeScript types re-exports from @cutpoint/core)
 ...
 *
 * API contract types come from @cutpoint/core.
 * This file contains ONLY re-exports - no local API contract definitions.
 */

// ============================================================================
// API Type Re-exports (from @cutpoint/core)
// ============================================================================
...
export type {{
  // Add types from @cutpoint/core/{domain_name}
}} from "@cutpoint/core";
 ...
 *
 * Architecture Rules:
 * - API types: re-exports from @cutpoint/core only
