/**
 * PublicationHoldRepository - DynamoDB Implementation
 *
...
/**
 * PublicationHoldRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing PublicationHold repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { PublicationHoldRepository } from "@cutpoint/services/governance";
...
/**
 * PublicationHoldRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: PUBLICATION_HOLD
 * Entity Token: PUBLICATION_HOLD
 * SK Prefix: PUBLICATION_HOLD
 */
export class PublicationHoldRepositoryDdb implements PublicationHoldRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "PUBLICATION_HOLD";
  private readonly ENTITY_TOKEN = "PUBLICATION_HOLD";
  private readonly SK_PREFIX = "PUBLICATION_HOLD";
  ...
  private readonly ENTITY_TYPE_PK = "PUBLICATION_HOLDS";
