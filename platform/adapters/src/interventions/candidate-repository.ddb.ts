...
import type { CandidateRepository } from "@cutpoint/services/interventions";
 ...
 *
 * Entity Type: INTERVENTION_CANDIDATE
 * Entity Token: INTERVENTION_CANDIDATE
 * SK Prefix: INTERVENTION_CANDIDATE
 */
export class CandidateRepositoryDdb implements CandidateRepository {
  ...
  private readonly ENTITY_TYPE = "INTERVENTION_CANDIDATE";
  private readonly ENTITY_TOKEN = "INTERVENTION_CANDIDATE";
  private readonly SK_PREFIX = "INTERVENTION_CANDIDATE";
  ...
  private readonly ENTITY_TYPE_PK = "INTERVENTION_CANDIDATES";
