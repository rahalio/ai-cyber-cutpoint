/**
 * ClassificationRunRepository - DynamoDB Implementation
 *
...
/**
 * ClassificationRunRepositoryDdb
 *
 * DDD: Infrastructure adapter implementing ClassificationRun repository using DynamoDB.
 * Generated from x-dynamodb metadata in OpenAPI schema.
 */

import type { ClassificationRunRepository } from "@cutpoint/services/labelling";
...
/**
 * ClassificationRunRepositoryDdb using DynamoDB table (type: core)
 *
 * Entity Type: CLASSIFICATION_RUN
 * Entity Token: CLASSIFICATION_RUN
 * SK Prefix: CLASSIFICATION_RUN
 */
export class ClassificationRunRepositoryDdb implements ClassificationRunRepository {
  private readonly TABLE_NAME: string;
  // Metadata from x-dynamodb annotation - all values are dynamic
  private readonly ENTITY_TYPE = "CLASSIFICATION_RUN";
  private readonly ENTITY_TOKEN = "CLASSIFICATION_RUN";
  private readonly SK_PREFIX = "CLASSIFICATION_RUN";
  ...
  private readonly ENTITY_TYPE_PK = "CLASSIFICATION_RUNS";
