/**
 * Discovery Services - Application Layer Export
 *
...
/**
 * Discovery Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for discovery domain.
 */
