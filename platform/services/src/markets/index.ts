/**
 * Markets Services - Application Layer Export
 *
...
/**
 * Markets Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for markets domain.
 */
